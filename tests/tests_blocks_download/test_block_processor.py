...
class TestBlocksProcessor:
    # process_block tests #
    def test_process_block_success(self, setup_block_processor):
    ...
    def test_process_block_already_fetched(self, setup_block_processor):
        block_processor, mock_api, mock_file_manager = setup_block_processor
    ...
    def test_process_block_interrupt(self, setup_block_processor):
        block_processor, mock_api, mock_file_manager = setup_block_processor
    ...
    def test_process_block_exception(self, setup_block_processor):
        block_processor, mock_api, mock_file_manager = setup_block_processor        
    ...
    def test_process_block_invalid_block_number(self, setup_block_processor):
        block_processor, mock_api, mock_file_manager = setup_block_processor    

        with pytest.raises(ValueError, match="Invalid block number"):
            block_processor.process_block(-1, [], [], None) 

    def test_process_block_invalid_timestamp(self, setup_block_processor):
        block_processor, mock_api, mock_file_manager = setup_block_processor              
        mock_api.get_block_timestamp.side_effect = lambda x: -1     
        
        with pytest.raises(ValueError, match="Invalid timestamp"):
            block_processor.process_block(20507193, [], [], None)  

    def test_process_block_invalid_transactions(self, setup_block_processor):
        block_processor, mock_api, mock_file_manager = setup_block_processor
